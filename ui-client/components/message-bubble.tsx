            ...
            <>
              {showJson && (
                <div className="mt-4 border-t border-gray-800 pt-4">
                  <div className="text-xs font-mono text-gray-400 mb-2">Raw Response:</div>
                  <JsonViewer data={message.rawResponse || {}} />
                </div>
              )}

              <div className="mt-4 pt-2 border-t border-gray-800 flex items-center justify-between text-xs text-gray-500 font-mono">
